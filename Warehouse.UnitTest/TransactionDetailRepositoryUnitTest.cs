...
{
	[TestClass]
	public class TransactionDetailRepositoryUnitTest : RepositoryTestBase<TransactionDetailRepository>
	{
		protected override ICollection<SqlParameter> GetInsertParameters()
		{
			...
			{
					new SqlParameter("@TransactionID", 15),
					new SqlParameter("@ProductID", 1),
					new SqlParameter("@UnitPrice", 1.00),
					new SqlParameter("@Quantity", 1.00),
